  ...
  return (
    <div className="bg-surface font-body text-on-surface selection:bg-primary-container selection:text-on-primary-container min-h-screen">
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="hidden md:flex flex-col fixed left-0 z-40 bg-[#f6f6f6] h-[calc(100vh-80px)] top-16 w-80 border-r-4 border-[#a400a4] shadow-2xl pt-8 px-4 overflow-y-auto">
          ...
          <nav className="space-y-2">
            <a className="flex items-center gap-4 text-zinc-500 hover:text-[#a400a4] hover:bg-zinc-200 p-4 font-semibold transition-all duration-300" href="#">
              <span className="material-symbols-outlined">functions</span>
              <span>Mathematics</span>
            </a>
            <a className="flex items-center gap-4 bg-[#a400a4] text-white p-4 font-semibold transition-all duration-300" href="#">
          ...
          <div className="mt-auto mb-10 p-4 bg-surface-container-low rounded-xl border-2 border-dashed border-outline-variant">
            <span className="font-label text-[10px] text-primary font-bold uppercase tracking-widest">Daily Goal</span>
        ...
        <main className="flex-1 md:ml-80 px-4 md:px-12 relative overflow-hidden bg-surface-container-lowest pt-12 pb-32">
          {/* Decorative Doodles */}
          ...
          <div className="max-w-4xl mx-auto py-12">
            <div className="mb-12 text-center md:text-left">
              <h2 className="font-headline text-5xl md:text-7xl font-black text-on-surface uppercase leading-none">
                The Study<br/><span className="text-primary italic">Quest</span>
              </h2>
            ...
            <div className="relative min-h-[1000px] flex flex-col items-center">
              {/* SVG Roadmap Path */}
              <svg className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1000px] pointer-events-none" display="none" fill="none" viewBox="0 0 400 1000">
              ...
              {/* Vertical Path Line (Hand-drawn look) */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-full bg-secondary/20 rounded-full hidden md:block">
                <div className="h-2/3 bg-secondary shadow-[0_0_15px_rgba(0,101,113,0.4)] rounded-full"></div>
              </div>

              {/* Milestone: Video Tutorials */}
              <div className="relative z-10 w-full flex justify-start md:pl-20 mb-32">
                <div className="group bg-surface-container-lowest p-6 rounded-xl shadow-[12px_12px_0px_#cafd00] border-2 border-on-surface w-full max-w-xs transform -rotate-2 hover:rotate-0 transition-transform cursor-pointer">
              ...
              <div className="relative z-10 w-full flex justify-end md:pr-20 mb-32">
                <div className="group bg-surface-container-lowest p-6 rounded-xl shadow-[12px_12px_0px_#ff5af9] border-2 border-on-surface w-full max-w-xs transform rotate-3 hover:rotate-0 transition-transform cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative z-10 w-full flex justify-start md:pl-32 mb-32">
                <div className="group bg-surface-container-lowest p-6 rounded-xl shadow-[12px_12px_0px_#26e6ff] border-2 border-on-surface w-full max-w-xs transform -rotate-1 hover:rotate-0 transition-transform cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2 opacity-50">
                    ...
                    <span className="font-label text-xs uppercase tracking-widest font-bold">Locked</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 w-full flex flex-col items-center mb-20">
                <div className="group bg-zinc-900 border-zinc-700 p-8 rounded-xl shadow-[16px_16px_0px_#b41340] border-4 w-full max-w-md transform hover:scale-105 transition-transform cursor-pointer">
                  <div className="flex items-center justify-center mb-6">
                    <div className="relative">
                      <span className="material-symbols-outlined text-red-500 text-7xl" style={{ fontVariationSettings: "'FILL' 1" }}>skull</span>
                      <span className="absolute -top-4 -right-4 bg-red-600 text-white text-[10px] font-black px-2 py-1 rounded-full uppercase italic animate-pulse">Boss Level</span>
                    </div>
                  </div>
                  <h3 className="font-headline text-3xl font-black text-white text-center mb-2 uppercase">Mock Test</h3>
                  <p className="text-zinc-500 text-sm text-center mb-6">Complete this to unlock the next chapter. No mercy.</p>
                  <button className="w-full bg-red-600 text-white font-label py-4 rounded-none uppercase tracking-widest font-black flex items-center justify-center gap-3 active:translate-y-1 transition-all">
      ...
      <div className="fixed bottom-0 left-0 w-full z-[60] pt-12 pb-8 pointer-events-none">
        <div className="max-w-2xl mx-auto px-4 pointer-events-auto">
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-surface-container-lowest border-2 border-on-surface p-2 rounded-xl shadow-2xl">
              <span className="material-symbols-outlined text-primary ml-2" style={{ fontVariationSettings: "'FILL' 1" }}>psychology</span>
              <input className="flex-1 bg-transparent border-none focus:ring-0 font-body text-sm px-4 placeholder:uppercase placeholder:font-black placeholder:tracking-tighter" placeholder="Have a doubt? Ask the AI Coach..." type="text"/>
